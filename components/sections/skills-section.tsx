...
const SkillsSection = () => {
  ...
  const skillCategories = [
    ...
    },
    {
      ...
      skills: ["Python (Advanced)", "Pandas", "NumPy", "Scikit-learn", "REST APIs", "Data Cleaning", "Data Processing", "SQL"],
    },
    {
      title: t("skills.database.title"),
      icon: Database,
      color: "from-orange-500 to-red-500",
      skills: ["PostgreSQL", "pgvector", "Supabase", "SQL", "Vector Databases", "Data Modeling", "Data Architecture", "ETL"],
    },
    {
    ...
    },
    {
      ...
      skills: ["Git", "GitHub", "Docker", "Linux", "Jupyter Notebooks", "VSCode", "Google Cloud", "Vercel"],
    },
  ]
